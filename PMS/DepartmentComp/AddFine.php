...
if (!$_SESSION['loggedin']) {
  ...
  if ($_POST['action'] == "update") {
    ...
    if (isset($_REQUEST['act']) && @$_REQUEST['act'] == "1") {
        $errormsg = "<div class='alert alert-success'><strong>Success!</strong> Fine Add successfully</div>";
    } else if (isset($_REQUEST['act']) && @$_REQUEST['act'] == "2") {
        $errormsg = "<div class='alert alert-success'><strong>Success!</strong> Fine Edit successfully</div>";
    } else if (isset($_REQUEST['act']) && @$_REQUEST['act'] == "3") {
        $errormsg = "<div class='alert alert-success'><strong>Success!</strong> Fine Delete successfully</div>";
    }
}
?>
                ...
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <?php echo ($action == "add") ? "Add Fine" : "Edit Fine"; ?>
                        </div>
                        <form action="AddFine.php" method="post" id="signupForm1" class="form-horizontal">
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="fine_name" name="fine_name" value="<?php echo $fine_name; ?>" />
                                    </div>
                                </div>
                ...
                $(document).ready(function() {
                    ...
                    if ($("#signupForm1").length > 0) {
                        $("#signupForm1").validate({
                            ...
                            messages: {
                                fine_name: "Please enter Valid Fine Name",
                                rate: "Please enter rate and only Digits ",
                                price: "Enter price Correctly",
                            },
                            errorElement: "em",
