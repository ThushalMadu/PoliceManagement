...
<body>
    ...
    <div class="container" id="container">
        <div class="w3-container">
            <h2>The Fines You Have Paid </h2>

            <p><em>Hey </em><?php echo $first_name; ?></p>
            <?php
            include "../../finalviva-hdv2/db.php";

            $querytable = "SELECT * FROM spot_fine_tbl WHERE driverLicNo='" . $driverLicNo . "' AND statuspay = 'Paid' ";
            ...
            while ($datatable = mysqli_fetch_row($resulttable)) {
                ...
                echo "<td> $datatable[0]</td><td> $datatable[3]</td> <td>$datatable[4]</td> <td>$datatable[2]</td>";
            ...
            ?>
            <div class="page">
                <a href="DriverHome.php" class="link">Back To You want to Pay</a>
            </div>
        </div>
    </div>
